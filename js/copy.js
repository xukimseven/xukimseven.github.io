(() => {
  ...
  document.addEventListener('copy', e => {
    ...
    if(selection.length <= 42) { return; } e.preventdefault(); const textdata="selection" + '\n\n' (author ? `作者: ${author}\n` : '') '链接: ' window.location.href '\n' '来源: window.location.host '著作权归作者所有。商业转载请联系作者获得授权，非商业转载请注明出处。\n\n'; htmldata="selection" '<br><br>'
